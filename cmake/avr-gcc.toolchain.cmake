...
# avr-gcc doesn't support shared libraries.
...
function(add_avr_executable EXECUTABLE_NAME)
   ...
   add_custom_target(
    ...
    add_custom_target(
        ...
        -c ${AVR_PROGRAMMER}
        -P ${AVR_UPLOADTOOL_PORT}
        ${AVR_UPLOADTOOL_OPTIONS} -n -v
        COMMENT "Get status from ${AVR_MCU}"
    )

    # Reads the fuse bytes from the AVR
    add_custom_target(
        avr_get_fuses
        ${AVR_UPLOADTOOL} -n
            -p ${AVR_MCU}
            ...
            -U hfuse:r:-:h
            -U efuse:r:-:h
        COMMENT "Read fuse bytes from ${AVR_MCU}"
    )
    ...
    add_custom_target(
        ...
        ${AVR_UPLOADTOOL}
            ...
            COMMENT "Set fuses - High[${AVR_H_FUSE}] Low[${AVR_L_FUSE}] Ext[${AVR_E_FUSE}]"
    )
