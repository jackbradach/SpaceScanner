...
#define CONFIG_DBG_HILO_BIT PD7
...
/* DAC config */
#define CONFIG_DAC_DDR DDRB
#define CONFIG_DAC_PORT PORTB
#define CONFIG_DAC_BIT_A PB1
#define CONFIG_DAC_BIT_B PB2
...
#define CONFIG_HT16K33_I2C_ADDR_0 0x70
